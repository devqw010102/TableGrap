...
function checkUsername(id) {
    ...
    const usernameId = "ownerRegisterId";
...
function EmailValidation() {
    const emailInput = document.getElementById("ownerRegisterEmail") || document.getElementById("emailId");
    const domainInput = document.getElementById("ownerRegisterDomain") || document.getElementById("emailDomainInput");
...
function selectDomain() {
    const domainInput = document.getElementById("ownerRegisterDomain") || document.getElementById("emailDomainInput");
    const domainSelect = document.getElementById("ownerEmailDomainSelect");
...
function checkPwdConfirm() {
    const pwdInput = document.getElementById("ownerRegisterPwd") || document.getElementById("newPassword");
    const confirmInput = document.getElementById("ownerRegisterPwdConfirm") || document.getElementById("pwdConfirm");
